...
public interface BedTrack {
	...
	BED("wiggle_0"),
	/**
	 * Equivalent to "type=wiggle_0" at the UCSC (http://genome.ucsc.edu/goldenPath/help/wiggle.html). Note that we
	 * handle Wiggle tracks as BedGraph tracks are defined. See

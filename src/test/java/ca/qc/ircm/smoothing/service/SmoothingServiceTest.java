...
public class SmoothingServiceTest {
  ...
  public void smoothing() throws Throwable {
    ...
    doAnswer(invocation -> {
      ...
      return null;
    }).when(executableService).smoothing(any(SmoothingCoreParameters.class),
        any(SmoothingEventListener.class));
    ...
    verify(executableService).smoothing(smoothingCoreParametersCaptor.capture(),
        any(SmoothingEventListener.class));
  ...
  public void smoothing_Color() throws Throwable {
    ...
    verify(executableService).smoothing(any(SmoothingCoreParameters.class),
        any(SmoothingEventListener.class));
    try (BufferedReader reader =
        new BufferedReader(new InputStreamReader(new FileInputStream(smoothedBed), "UTF-8"))) {
